...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark " >
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="link2 page.php">Hospital Tour</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="3.php">Link</a>
                  </li>
...
<h2 class="py-2" style="text-align: center;">Login Form</h2>
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
  ...
  <div class="container">
                ...
                <input type="text" name="username" class="form-control" style="width: 600px;" value="<?php echo $username; ?>"></br>
                <span class="help-block"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <label>Password</label></br>
                <input type="password" name="password" class="form-control" style="width: 600px;">
